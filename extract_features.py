...
def main(args):
    ...
    if rank == 0:
        ...
        os.makedirs(os.path.join(args.features_path, f'features_{args.fold}'), exist_ok=True)
        os.makedirs(os.path.join(args.features_path, f'labels_{args.fold}'), exist_ok=True)
